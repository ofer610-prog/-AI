...
## כלל ברזל — סריקה לפי כרטיס אשראי בלבד

**Gmail וגם Outlook** מחפשים **רק** לפי 4 ספרות אחרונות של כרטיס.
אסור להוסיף שאילתות לפי שולח / מילות מפתח / קבצים מצורפים.

- המספרים נלקחים מ-`org.office_card_last4` + env var `OFFICE_CARD_LAST4`
- אם אין כרטיסים מוגדרים — הסורק מחזיר שגיאה, לא סורק דבר
- Gmail: `after:... before:... 1626`  |  Outlook: `$search="1626"`
