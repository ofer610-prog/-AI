...
export async function sendEmail({ to, subject, html, attachments }) {
  ...
  try {
    ...
    const payload = { from: `משרד עורכי דין <${from}>`, to, subject, html };
...
export function buildInvoiceClientMessage({ clientName, invoiceNumber, amount, issueDate, dueDate, notes, officeName }) {
  return [
    `שלום ${clientName},`,
    ``,
