...
export async function scanOrg(sb, org, daysBack = 120) {
  ...
  for (const msg of [...found.values()]) {
    try {
      ...
      // d.action === 'auto_import' → שמירה ל-Drive + רישום אוטומטי
