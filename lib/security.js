 ...
 *   buildAuditEntry('action_name', { ...details })            // legacy
 *   buildAuditEntry({ organizationId, action, entityType,     // rich
 *                     entityId, userId, sourceChannel,
 *                     sourceMessageId, approved, details })
 *
 * The rich shape maps to the real audit_log columns
 * (organization_id / entity_type are NOT NULL in the DB), folding any
 * extra provenance fields into the jsonb `details` column.
 */
export function buildAuditEntry(actionOrObj, details = {}) {
  ...
  return {
    ...
    action: o.action || 'unknown',
    entity_type: o.entityType || o.entity_type || 'system',
    entity_id: o.entityId || o.entity_id || null,
    details: {
      ...(o.details || {}),
      ...(o.sourceChannel ? { source_channel: o.sourceChannel } : {}),
      ...(o.sourceMessageId ? { source_message_id: o.sourceMessageId } : {}),
